...
## Creating powerful, transparent decision aids with FFTrees
...
### Early attempt: HDPI
<br3>
<font size = 5>- Heart Disease Predictive Instrument (HDPI), a logistic regression solution.</font>
...
<font size = 5>- Why: Don't trust the tool, high confidence in individual decisions, and lack of time.</font>
...
<br3>
<b>Result</b><br>
FFT (not yet public) makes decisions using ~3 features (including social situation at time of intake) with performance similar to regression.
